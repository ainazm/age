let Name = document.querySelector("div>input.name");
let father = document.querySelector("div>input.father");
let gender = document.querySelector("div>input.gender");
let nationalCode = document.querySelector("div>input.nationalCode");
...
let country = document.querySelector("div>input.country");
...
submit.addEventListener("click", function () {
  ...
  document.querySelector("h1.name").innerHTML = Name.value;
  document.querySelector("h1.father").innerHTML = father.value;
 
  document.querySelector("h1.gender").innerHTML = gender.value;
  document.querySelector("h1.nationalCode").innerHTML = nationalCode.value;
  document.querySelector("h1.country").innerHTML = country.value;
